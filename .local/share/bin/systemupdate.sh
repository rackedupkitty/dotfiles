...
ignore_pkgs="hyprpicker opera spotify spicetify-cli spotify-adblock discord visual-studio-code-bin whatsdesk-bin chromium morgen-bin gimp hyprland hyprutils aquamarine hyprgraphics hyprland-guiutils hyprland hyprtoolkit hyprwire xdg-desktop-portal-hyprland hyprlang libjxl audit libpcap obs-studio-git lib32-audit lib32-libpcap"
